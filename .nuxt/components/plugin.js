...
const components = {
  ...
  Waiting: () => import('../../components/Waiting.vue' /* webpackChunkName: "components/waiting" */).then(c => c.default || c),
  ...
  AdminTodos: () => import('../../components/admin/Todos.vue' /* webpackChunkName: "components/admin-todos" */).then(c => c.default || c),
