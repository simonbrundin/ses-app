...
const components = {
  ...
  MatchSchedule: () => import('../..\\components\\MatchSchedule.vue' /* webpackChunkName: "components/match-schedule" */).then(c => c.default || c),
