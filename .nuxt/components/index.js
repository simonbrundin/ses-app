...
export { default as NotificationsScheduleInstructions } from '../..\\components\\notifications\\ScheduleInstructions.vue'
export { default as NotificationsWaitingForPlayers } from '../..\\components\\notifications\\WaitingForPlayers.vue'

export const LazyAuth = import('../..\\components\\auth.vue' /* webpackChunkName: "components/auth" */).then(c => c.default || c)
export const LazyBook = import('../..\\components\\Book.vue' /* webpackChunkName: "components/book" */).then(c => c.default || c)
...
export const LazyIconsIconCalendar = import('../..\\components\\icons\\IconCalendar.vue' /* webpackChunkName: "components/icons-icon-calendar" */).then(c => c.default || c)
export const LazyIconsIconClock = import('../..\\components\\icons\\IconClock.vue' /* webpackChunkName: "components/icons-icon-clock" */).then(c => c.default || c)
export const LazyIconsIconCup = import('../..\\components\\icons\\IconCup.vue' /* webpackChunkName: "components/icons-icon-cup" */).then(c => c.default || c)
export const LazyIconsIconHome = import('../..\\components\\icons\\IconHome.vue' /* webpackChunkName: "components/icons-icon-home" */).then(c => c.default || c)
...
export const LazyNotificationsScheduleInstructions = import('../..\\components\\notifications\\ScheduleInstructions.vue' /* webpackChunkName: "components/notifications-schedule-instructions" */).then(c => c.default || c)
export const LazyNotificationsWaitingForPlayers = import('../..\\components\\notifications\\WaitingForPlayers.vue' /* webpackChunkName: "components/notifications-waiting-for-players" */).then(c => c.default || c)
